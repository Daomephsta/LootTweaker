...
/**
 * Handles deprecation warnings. Makes sure they're printed once for each
 * deprecated function to avoid log spam.
 */
...
public class DeprecationWarningManager
{
    ...
    public static void addWarning()
    {
        ...
        try
        {
            ...
            if (zenClass == null) throw new IllegalArgumentException(clazz.getName() + " is not a ZenClass");
    ...
    public static void printDeprecationWarnings()
    {
        ...
        CraftTweakerAPI.logWarning(
            "LootTweaker: One or more scripts use deprecated methods. Check crafttweaker.log for more information.");
        ...
        CraftTweakerAPI.logInfo(
            "Refer to https://loottweaker-docs.readthedocs.io/en/latest/reference/deprecations.html for more info. This warning can be disabled in the config.");
    }
}
