...
foo_bar.addLootTableEntry("loottweaker:bar", 5, null);
foo_bar.addLootTableEntry("loottweaker:bar", 2, null);
//customNamedTableReference
foo_bar.addLootTableEntry("loottweaker:bar", 5, "grault_naming");
foo_bar.addLootTableEntry("loottweaker:bar", 2, null);
//multipleEmpties
