...
public class CommandLootTables extends CraftTweakerCommand
{
    ...
    //Copied from EntityRenderer#getMouseOver() and modified to work on any side
	...
	Vec3d vec3d3 = null;
	List<Entity> list = entity.getEntityWorld().getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().expand(look.x * distance, look.y * distance, look.z * distance).grow(1.0D, 1.0D, 1.0D), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>()
	{
