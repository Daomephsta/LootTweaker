...
public class LootFunctionManagerAccessors extends AbstractAccessors
{
	...
	static
	{
		try
		{
			LootFunctionManager$CLASS_TO_SERIALIZER_MAPGetter = createFieldGetter(LootFunctionManager.class, "field_186585_b", "CLASS_TO_SERIALIZER_MAP");
		}
		catch (Throwable t)
		{
	...
	public static Map<Class<? extends LootFunction>, LootFunction.Serializer<?>> getClassToSerialiserMap()
	{
		try
		{
			return (Map<Class<? extends LootFunction>, LootFunction.Serializer<?>>) LootFunctionManager$CLASS_TO_SERIALIZER_MAPGetter.invokeExact();
		}
		catch (Throwable t)
		{
			throw new RuntimeException("Could not invoke LootFunctionManager class to serialiser map getter method handle", t);
		}
	}
}
